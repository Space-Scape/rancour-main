...
boss_drops = {
    ...
    "Colosseum": ["Smol heredit", "Dizana's quiver (uncharged)", "Sunfire fanatic cuirass", "Sunfire fanatic chausses", "Sunfire fanatic helm", "Echo crystal", "Tonalztics of ralos (uncharged)"],
    ...
    "Gauntlet": ["Youngllef", "Crystal weapon seed", "Crystal armor seed", "Enhanced crystal weapon seed"],
    ...
    "Scorpia":["Odium shard 3",	"Malediction shard 3", "Scorpia's offspring"],
    ...
    "Zulrah": ["Pet snakeling", "Tanzanite fang", "Magic fang", "Serpentine visage", "Uncut onyx"],
