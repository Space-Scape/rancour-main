...
async def rules(interaction: discord.Interaction):
    ...
    rule_data = [
        ...
        ("Rule 2️⃣ - Follow All In-Game & Discord Rules", "This should go without saying, but if rule-breaking is inappropriate for Jagex and Discord's ToS, it is also inappropriate here. If you are found to be engaging in this sort of behaviour inside or outside of the clan, it will result in your removal from this server following a ban. No one needs this kind of behaviour in their lives. We're all adults, and we will not allow it to spill over into the clan without taking action.\n\nThe following will **NOT** be tolerated:\n\n⊘ Racism\n⊘ Macroing\n⊘ Solicitation\n⊘ Advertising websites for GP\n⊘ Scamming\n⊘ Ethnic slurs\n⊘ Hate speech"),
