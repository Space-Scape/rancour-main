...
async def rules(interaction: discord.Interaction):
    ...
    rule_data = [
        ...
        ("Rule 4️⃣ - No Rage-Quitting Raids/Bosses", "Angrily leaving/\"rage quitting\" raids mid-raid and bosses mid-trip is heavily frowned upon, and will often result in a warning. You wouldn't like it if it happened to you, so please don't do it to others. We ask that you continue the raid when possible and peacefully let others know you would prefer not to do another."),
